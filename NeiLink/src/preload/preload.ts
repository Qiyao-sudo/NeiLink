...
const invokeChannels: string[] = [
  ...
  IPC_CHANNELS.NETWORK_SELECT_ADAPTERS,
  ...
  IPC_CHANNELS.APP_DOWNLOAD_PAUSE,
  IPC_CHANNELS.APP_DOWNLOAD_RESUME,
  IPC_CHANNELS.APP_DOWNLOAD_CANCEL,
